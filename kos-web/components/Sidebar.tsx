    ...
    return (
        <div className="flex w-64 shrink-0 flex-col border-r border-navy-100 bg-white">
            ...
            <nav className="flex-1 space-y-1 p-4">
                <div className="mb-4 px-3 text-xs font-semibold uppercase tracking-wider text-ink-faint">
                    Menu Utama
                </div>
                {navItems.map((item) => {
                        ...
                        <Link
                            ...
                            className={cn(
                                ...
                                isActive
                                    ...
                                    : "text-ink-muted hover:bg-navy-50 hover:text-ink"
                            )}
                        >
                ...
                {isAdmin && (
                    <>
                        <div className="mb-4 mt-6 px-3 text-xs font-semibold uppercase tracking-wider text-ink-faint">
                            Admin Panel
                        </div>
                        <Link
            ...
            <div className="border-t border-navy-100 p-4">
                ...
                <div className="flex gap-1">
                    <Link
                        ...
                        className="flex flex-1 items-center justify-center gap-2 rounded-[var(--radius-control)] px-2 py-1.5 text-xs font-medium text-ink-muted hover:bg-navy-50 hover:text-ink"
                    >
                        <User className="h-3.5 w-3.5" /> Profil
                    </Link>
                    <button className="flex flex-1 items-center justify-center gap-2 rounded-[var(--radius-control)] px-2 py-1.5 text-xs font-medium text-red-600 hover:bg-red-50">
